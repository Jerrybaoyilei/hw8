...
public class AlbumTest {
  ...
  public void testTakeScreenshot() {
    ...
    assertEquals(1, album.getAlbumList().size());
    assertEquals(new Oval("O", 500.0, 100.0, 0, 0, 1, 60.0, 30.0),
            album.getAlbumList().get(0).getCopiedList().get(0));
  }
  ...
  public void testRemoveSnapshot() {
    ...
    assertEquals(2, album.getAlbumList().size());
  ...
  public void testRemoveSnapshotAtIndex() {
    ...
    assertEquals(new Oval("O", 500.0, 100.0, 0, 0, 1, 60.0, 30.0),
            album.getAlbumList().get(0).getCopiedList().get(0));
    assertEquals(new Rectangle("R", 200.0, 200.0, 1, 0, 0, 50.0, 100.0),
            album.getAlbumList().get(0).getCopiedList().get(1));
  ...
  public void removeByTimestamp() {
    ...
    String timestamp = album.getAlbumList().get(0).getTimestamp();

    album.removeByTimestamp(timestamp);

    assertEquals("2nd snapshot", album.getAlbumList().get(0).getDescription());
  ...
  public void testRemoveByDescription() {
    ...
    assertEquals("1st snapshot", album.getAlbumList().get(0).getDescription());
  ...
  public void getIdList() {
    ...
    assertEquals(album.getAlbumList().get(0).getId(), album.getIdList().get(0));
  }
  ...
  public void testToString() {
    ...
    String expected = "Printing Snapshots\n"
            + "Snapshot ID: " + album.getAlbumList().get(0).getId() + "\n"
            + "Timestamp: " + album.getAlbumList().get(0).getTimestamp() + "\n"
            ...
            + "Snapshot ID: " + album.getAlbumList().get(1).getId() + "\n"
            + "Timestamp: " + album.getAlbumList().get(1).getTimestamp() + "\n"
