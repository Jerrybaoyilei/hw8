...
public class ShapesActionTest {
  ...
  public void add() {
    ...
    assertEquals(list1.get(0), new Oval("O", 500.0, 100.0, 0.0, 0.0, 1.0, 60.0, 30.0));
    assertEquals(list1.get(1), new Rectangle("R", 200.0, 200.0, 1.0, 0.0, 0.0, 50.0, 100.0));
  }
  ...
  public void testChangeColor() {
    ...
    assertThrows(IllegalArgumentException.class, () -> {
      ShapesAction.changeColor(list1, 0, 255.01, 45, 68);
    });

    assertThrows(IllegalArgumentException.class, () -> {
      ShapesAction.changeColor(list1, 0, 255.01, 2568, -1839);
    });
  }
